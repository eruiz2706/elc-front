            ...
            @csrf
              ...
              <div class="form-check-inline">
                <label class="form-check-label" for="radio1">
                  <input type="radio" class="form-check-input" id="radio1" name="optradio" value="study" v-model="row.rol">Estudiante
                </label>
              </div>
              <div class="form-check-inline">
                <label class="form-check-label" for="radio2">
                  <input type="radio" class="form-check-input" id="radio2" name="optradio" value="teacher" v-model="row.rol">Profesor
                </label>
              </div>
              <div class="form-check-inline">
                <label class="form-check-label" for="radio3">
                  <input type="radio" class="form-check-input" id="radio3" name="optradio" value="institution" v-model="row.rol">Institucion
                </label>
              </div>
              <div class="form-check-inline">
                <label class="form-check-label" for="radio4">
                  <input type="radio" class="form-check-input" id="radio4" name="optradio" value="family" v-model="row.rol">Padre de familia
                </label>
              </div>
              <p></p>
...
@section('scripts')
  @parent
  <script src="{{ URL::asset('js/be/register.js') }}"></script>
@stop
