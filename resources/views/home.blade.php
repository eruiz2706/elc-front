          ...
          <div class="card-body box-profile">
            <div class="text-center">
              <img class="profile-user-img img-fluid img-circle"
                   src="{{ URL::asset('rsc/dist/img/user4-128x128.jpg') }}"
                ...
                <ul class="nav nav-pills flex-column">
                  <li class="nav-item">
                    <a href="mailbox.html" class="nav-link">
                      <i class="fa fa-inbox"></i> Curso 1
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="mailbox.html" class="nav-link">
                      <i class="fa fa-inbox"></i> Curso 2
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="mailbox.html" class="nav-link">
                      <i class="fa fa-inbox"></i> Curso 3
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="mailbox.html" class="nav-link">
                      <i class="fa fa-inbox"></i> Curso 4
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="mailbox.html" class="nav-link">
              ...
              <div class="tab-content">
                <div class="active tab-pane" id="activity">
                  ...
                  <div class="post clearfix">
                    <div class="user-block">
                      <img class="img-circle img-bordered-sm" src="{{ URL::asset('rsc/dist/img/user7-128x128.jpg') }}" alt="User Image">
                      <span class="username">
                        <a href="#">Sarah Ross</a>
                        <a href="#" class="float-right btn-tool"><i class="fa fa-times"></i></a>
                      </span>
                  ...
                  <div class="post">
                    <div class="user-block">
                      <img class="img-circle img-bordered-sm" src="{{ URL::asset('rsc/dist/img/user6-128x128.jpg') }}" alt="User Image">
                      <span class="username">
                        <a href="#">Adam Jones</a>
                        <a href="#" class="float-right btn-tool"><i class="fa fa-times"></i></a>
                      </span>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-sm-6">
                        <div class="row">
                          <div class="col-sm-6">
                            <img class="img-fluid mb-3" src="{{ URL::asset('rsc/dist/img/photo2.png') }}" alt="Photo">
                            <img class="img-fluid" src="{{ URL::asset('rsc/dist/img/photo3.jpg') }}" alt="Photo">
                          </div>
                          <!-- /.col -->
                          <div class="col-sm-6">
                            <img class="img-fluid mb-3" src="{{ URL::asset('rsc/dist/img/photo4.jpg') }}" alt="Photo">
                            <img class="img-fluid" src="{{ URL::asset('rsc/dist/img/photo1.png') }}" alt="Photo">
                          </div>
                          <!-- /.col -->
                        </div>
